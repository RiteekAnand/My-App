...
public class LoginActivity extends AppCompatActivity {
    ...
    private void alertMethod() {
        ...
        builder.setPositiveButton(Html.fromHtml("<font color='#F61C0C'>No</font>"), new DialogInterface.OnClickListener() {
            @Override
        ...
        builder.setNegativeButton(Html.fromHtml("<font color='#4CAF50'>Yes</font>"), new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialogInterface, int i) {
                finishAffinity();
            }
